...
simSCR0Poisson <- function(discard0 = TRUE, N=N, K=25, p0=0.1, sigma=1,
  ...
  if (array3d) {
    ...
    Y[,c(14,15,16,22,23,24,30,31,32,39,40,46,47,48,54,55,56,63,64,9,17,18,19,25,26,27,33,34),]<-0.25*Y[,
       c(14,15,16,22,23,24,30,31,32,39,40,46,47,48,54,55,56,63,64,9,17,18,19,25,26,27,33,34),]
